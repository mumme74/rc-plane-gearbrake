...
// refactored to not interfere with Servo.h

#define NO_TIMER_0_TO_2 1
...
# endif
      ...
      case 3:
        ...
        bitWrite(TIMSK3, OCIE3A, _freq > 0);
        if (_freq <= 0)
      ...
      case 4:
        ...
        bitWrite(TIMSK4, OCIE4A, _freq > 0);
        if (_freq <= 0)
      ...
      case 5:
        ...
        bitWrite(TIMSK5, OCIE5A, _freq > 0);
        if (_freq <= 0)
